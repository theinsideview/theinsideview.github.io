...
Connor was the first guest of this podcast. In the last episdoe, we talked a lot about [EleutherAI](https://www.eleuther.ai/), a grassroot collective of researchers he co-founded, who open-sourced GPT-3 size models such as GPT-NeoX and GPT-J.
...
In this episode, we go through the famous AI Alignment compass memes, discuss Connor's inside views about AI progress, how he approaches AGI forecasting, his takes on Eliezer Yudkowsky's secret strategy, common misconceptions and EleutherAI, and why you should consider working for his new company Conjecture.

<sup><sub><i>(Note: Our conversation is 3h long, so feel free to click on any sub-topic of your liking in the Outline below, and you can then come back to the outline by clicking on the arrow ⬆)</i></sub></sup>
