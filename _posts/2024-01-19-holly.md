...
spotifyId: 5hVbduMHPkE0DEkURXwZt0
---

{% include youtubePlayer.html id=page.youtubeId %}
{% include spotifyPlayer.html id=page.spotifyId %}

Holly Elmore is an AI Pause Advocate who has organized two protests in the past few months (against Meta's open sourcing of LLMs and before the UK AI Summit), and is currently running the US front of the Pause AI Movement. She previously worked at Rethink Priorities and has a PhD in evolutionary biology from Harvard.
