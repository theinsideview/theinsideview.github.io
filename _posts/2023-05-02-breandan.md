...
**Michaël**: I have no idea how many GPUs Google is using for the training POM. Maybe they can use older servers. Maybe there's something like, you can see like with a thermal camera from above that they're using a lot of GPUs, but compared to like their normal use of GPUs, I don't know. 
