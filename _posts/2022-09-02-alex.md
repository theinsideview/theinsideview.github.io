...
spotifyId: 0hPQ9SvLfDXWtoiCTzWHGZ
---
...
**Alex**:
I actually didn't know that. Thanks, that's really nice to hear. <a href="#contents">⬆</a>
...
**Michaël**:
Hopefully, there will be a nice way to look at your videos with a video here or there.

**Alex**:
We'll try, or we can just cut the pointing. <a href="#contents">⬆</a>
...
**Alex**:
Yeah. Well, also when I was losing, I still... <a href="#contents">⬆</a>
...
**Michaël**:
The Inside View, on people's inside views about Artificial Intelligence.<a href="#contents">⬆</a>
...
![WeakAGI](https://raw.githubusercontent.com/theinsideview/theinsideview.github.io/main/assets/weak_agi.png)
...
**Alex**:
Yeah. If you think about drawing a probability distribution, the median is the point where there's equal area on each side. And so, "How do you get equal area on each side?" If one of them can just be way further out than the other, you just need to have... it needs to be higher up on the left. <a href="#contents">⬆</a>
...
**Alex**:
It is a very slight adjustment to the transformer architecture. <a href="#contents">⬆</a>


## Maximizing Your Own Impact Using Forecasting

**Michaël**:
Interesting. Maybe we can move on to forecasting other things. I think you mentioned that you could apply those forecasting techniques for thinking about jobs or career.
...
**Alex**:
So anyway, you draw this relatively smooth curve through GDP... throughout history. And the shape of that curve is such that it goes vertical before 2100. And does that mean we're going to get infinite growth before 2100? Obviously not, but it means something weird's going to happen, at least according to this model. I think some people find this... Well, this sort of thing could be used to do two different things and you might have to remind me what they are. So, one is, "Make an active prediction," and one is, "Respond to another reference class argument."
...
**Alex**:
I mean, there might be, I don't know. But I think that curve fitting does not give you enough evidence to just go, "Okay, so now you should be confident there's this weird thing happening then," but it does give you enough confidence to go like, "Oh, man, I should actually look at the object level now because my reference class doesn't say normal stuff don't really worry about it." Maybe we can link to some [our world in data](https://ourworldindata.org/) graph. If you just look at [GDP growth throughout history](https://ourworldindata.org/grapher/gdp-per-capita-maddison-2020?country=IDN~ARG~KOR~FRA~GBR~USA~AUT~IND~CHN)... Yeah, just do the funny graph. Sorry for podcast listeners, this is going to suck for you.

![Gdp](https://raw.githubusercontent.com/theinsideview/theinsideview.github.io/main/assets/gdp_throughout_history.png)
...
![Gdp](https://raw.githubusercontent.com/theinsideview/theinsideview.github.io/main/assets/gdp.png)
