...
Collin Burns is a second-year ML PhD at Berkeley, working with Jacob Steinhardt and Dan Klein. His focus is on making language models honest, interpretable, and aligned, and he has also worked on multiple benchmarks, including APPS for coding from the MATH dataset and MMLU for language understanding.

More recently he published "Discovering latent knowledge in language models without supervision", a paper that has received a lot of praise on [dignified](https://twitter.com/ESYudkowsky/status/1601768272374165505) and [Lesswrong](https://www.lesswrong.com/posts/L4anhrxjv8j2yRKKp/how-discovering-latent-knowledge-in-language-models-without).
