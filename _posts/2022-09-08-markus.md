...
[Markus Anderljung](https://twitter.com/manderljung?lang=en) is the Deputy Director and Head of AI Policy at the [Center for Governance of AI](https://governance.ai/) in Oxford, he was previously seconded to the UK government office as a senior policy specialist.

In this episode we discuss [Jack Clark](https://twitter.com/jackclarkSF)'s [AI Policy takes](https://twitter.com/jackclarksf/status/1555980412333133824), answer AI Governance questions from Twitter, discuss what AI Governance
...
* [Jack Clark's AI Policy Takes: Agree or Disagree](#jack-clarks-ai-policy-takes-agree-or-disagree)
    ...
    * [Will AI Governance Be Useful Assuming Short Timelines And Fast Takeoff?](#will-ai-governance-be-useful-assuming-short-timelines-and-fast-takeoff)
    * [Are We Preventing A Literal Arms Race?](#are-we-preventing-a-literal-arms-race)
    * [Can We Actually Regulate Technological Progress?](#can-we-actually-regulate-technological-progress)
    * [Compute Regulation](#compute-regulation)
* [The Centre For The Governance Of AI](#the-centre-for-the-governance-of-ai)
    * [AI Governance Bets](#ai-governance-bets)
    * [Why Regulate AI](#why-regulate-ai)
    * [GovAI Output](#govai-output)
    * [Hiring Pitch](#hiring-pitch)
* [AI Governance](#thinking-about-agi)
    * [Broader AI Governance Space](#broader-ai-governace-space)
    * [AGI Policy and Governance](#agi-policy-and-governance)
    * [AI Governance in Practice](#ai-governance-in-practice)
    * [Self-Driving Regulation](#self-driving-regulation)
    * [AI Regulation by EU](#ai-regulation-by-eu)
    * [Arguments Against Regulation](#arguments-against-regulation)
    * [Model Auditing and Scrutiny](#model-auditing-and-scrutiny)
...
**Markus**:
Primarily, if you think about frontier development, definitely, the US is the main place where it's happening.
...
**Michaël**:
We're seeing even people talk about advanced AI systems in The New Yorker or in The Times with a new article on AI.
...
**Markus**:
One reason against that is, if we just look at the history of other technologies, quite often a thing that you see is initially when the technology comes into place, there is a accumulation of wealth and power as a result of this technology into a small number of actors, and then over time that diffuses. Partly via government intervention. So for example, we saw this in the late 1800's, early 1900's, in the US, because of the robber barons, we now have Antitrust Regulations. And if it's the case that development is slow enough that policymakers are going to see that this power is going to be concentrated, be really worried about it, then I would expect that you start moving away from this Snow Crash wonderland a little bit.
...
## Will AI Governance Be Useful Assuming Short Timelines And Fast Takeoff?
...
## Can We Actually Regulate Technological Progress?
...
**Markus**:
And one thing that I think seems plausible, is a person who can do that well, is a person who could do judgemental forecasting well. So someone who can take a question like, I don't know, will Putin remain the president of Russia?
...
**Markus**:
Then there're some changes are being made to the EU liability directive. This is about these things of, "If something goes wrong with a product, who is held responsible? Who needs to pay for the mistake?"
...
**Markus**:
Seems very hard to implement. I don't know how it'll happen in practice. Maybe it'll be the kind of thing that the platforms end up helping implement. But I'm not really sure.
...
**Markus**:
There is this report that I was mentioning on the extent to which we'll see regulatory diffusion from the EU. There's this thing that people call the Brussels Effect, which is the thought is that sometimes the EU regulates things. In particular, they regulate products. They're like, "Okay, well, you can only sell your thingamajig in the EU if you fulfill these requirements."

**Markus**:
And then the developer or the producer of this thingamajig, they have to rejig their whole factory to produce a thingamajig in a EU compliant way. And then once they've done that, they're like, "Ugh, God. Okay, well, either we could create a new factory that does this, and we sell the non compliant thingamajig outside of the EU, and the compliant one inside of the EU. Or we could just sell the compliant one globally."
...
**Michaël**:
As the head of the entire universe government.

**Markus**:
Exactly. When I become head of policy for the world.
