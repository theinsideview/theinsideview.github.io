...
**Katja**:
Sometimes. I used to. <a href="#contents">⬆</a>
...
**Katja**:
Yeah. As in, there are some kinds of preparation you can do that are more helpful across a range of circumstances. Maybe they're easier to do ahead of time. And other ones that are more dependent on circumstance, so it's harder. <a href="#contents">⬆</a>
