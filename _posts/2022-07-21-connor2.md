...
Connor was the first guest of this podcast, and it’s a pleasure to have him again for another round. In the last episode, we had a zoom call from our bedrooms, and we talked a lot about [EleutherAI](https://www.eleuther.ai/), a grassroot collective of researchers he co-founded, who open-sourced GPT-3 size models such as GPT-NeoX and GPT-J.

Since then, with some of the core members of EleutherAI, Connor co-founded [Conjecture](https://www.conjecture.dev/), a company aiming to make AGI safe through scalable AI Alignment research. One of the goals of Conjecture is to reach a fundamental understanding of the internal mechanisms of current deep learning models using interpretability techniques.

This is the first in-person interview of this podcast, and hopefully not the last one. Our conversation is 3h long, so feel free to click on any sub-topic of your liking in the Outline below.
