...
* [AGI Forecasting](#agi-forecasting)
    ...
    * [On The Metaculus AGI Questions](#on-the-metaculus-agi-questions)
    * [How Alex's AI Timelines Differ From Metaculus](#how-alexs-ai-timelines-differ-from-metaculus)
    * [Using Forecasting To Maximize Impact](#using-forecasting-to-maximize-impact)
...
* [How Alex Developed Inside Views About AI Alignment](#how-alex-developed-inside-views-about-ai-alignment)
    * [Passing AI Alignment Ideological Turing Tests](#passing-ai-alignment-ideological-turing-tests)
    * [Using Economic Growth To Forecast AI Progress](#using-economic-growth-to-forecast-ai-progress)
...
**Michaël**:
So, Inside View, to get people's inside views about Artificial Intelligence. And I guess the last episode, maybe it will be two episodes before, I don't know, depending on when I publish this, was with [Connor Leahy](https://theinsideview.ai/connor2) about how he updated on recent progress. That was one of the things. And I guess one claim was that if there were some events that always went into the same direction... For instance, scaling transformers led to increased performance and decreasing loss with no diminishing returns, the same rate of the [inaudible 00:14:51] diminishing.
...
## On The Metaculus AGI Questions
...
## Using Forecasting To Maximize Impact
...
## Passing AI Alignment Ideological Turing Tests
...
## Using Economic Growth To Forecast AI Progress
