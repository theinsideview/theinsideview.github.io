...
**Michaël**: Connor, you were the first guest on this podcast, and it's a pleasure to have you again on the show. In the last episode, we had a Zoom call from our bedrooms. And we talked a lot about EleutherAI, a grassroot collective of researchers who co-founded open-sourced GPT-3-like models, such as GPT Neo-X and GPT-J.

**Michaël**: Since then with some of the core members of Eleuther, you co-founded Conjecture, a company aiming to make AGI safe, through scalable AI alignment research. One of the goals of Conjecture is to reach a fundamental understanding of the internal mechanisms of current deploying models using interpretability techniques.

**Michaël**: I'm excited to finally be doing in-person interviews with you, in Oakland, California, where some of your team is currently visiting. Thanks Connor for coming on the show, it's a pleasure to have you.

**Connor**: It's a pleasure to be back.

**Michaël**: To start this interview, I would want to focus on what I find unique in Conjecture's culture. There's a joke that EleutherAI is a glorified Discord server. And yeah, Conjecture has, as far as I know, Discord as a primary means of communication. When I want to come to this office, I had to get an intro on Discord. I couldn't use email.

## AI Alignment Meme Review

**Michaël**: And I think, most importantly, your company believes that AI alignment is a hard problem. And also that AGI met comes soon, which is known in the Twitter literature as AGI soon and AI alignment hard. And we'll talk about those dimensions a lot, but I think to understand better all of this, it's good to just look at the memes because one of the most important things that has happened in 2022 was the great air conditioner debate. And the second thing has been the political compass meme. So I brought with me the... Oh, this is the correct one. This is weird. Yeah, the original meme that created all of this. And I wanted to get your reaction on camera, which is how did you react when you saw this meme? And did you find it somehow represent your views? My first reaction to this meme was, hey, I'm in good company.

![FirstMeme](https://raw.githubusercontent.com/theinsideview/theinsideview.github.io/main/assets/connor_edit.png){ width="100%" height="100%" style="display: block; margin: 0 auto" }
...
**Michaël**: So I made another one after the reactions from this one where I had this quote where you said that you're maybe more scale pilled than Eliezer and less de marish than him.

**Michaël**: So now you ended up being in this top right quadrant. Did you have another reaction from this one or is it basically the same thing?
...
**Michaël**: This is the big brain meme. This explains the other one because the other one is like a projection using something like PCA and there's this... I guess the only one I'm not sure about is your slightly conscious access.

**Connor**: I mean, that's just the shit post access, right?

**Michaël**: Right.

**Connor**: I'm pretty sure Yosha was shit posting on that thread about what he believes. I don't know Yosha that well but-
...
**Michaël**: I think it's 26, 2030 for you.
...
**Connor**: So I updated hard on GPT-3, so I was already updating on GPT-2. My biggest update, I think on timelines was the release of GBT-2, a hundred million parameters. That was the really, really terrible model that could barely string together a coherent sentence. And I remember seeing that for the first time and I was just like, holy shit, this is amazing. This is the most amazing thing I've ever seen in my life. And a lot of other people didn't update as strongly as I did on that. But I was already like, holy shit. We're actually going to see AGI dudes. This is actually crazy. I didn't update all the way to super short timelines. I was still like, I don't know, 2045 at that time or something.

**Connor**: But then when GBT-3 came out and especially because it didn't need new techniques, they just scaled the model larger. It makes such a huge difference, that's when I started to really update. And so that's when I was was started EleutherAI because I was like, oh, holy shit, I'm updating hard on this, I'm pivoting. We need to work on this. After GBT-2, I was kind of like, this is probably the end of the road. I'm going to work on something different for a while and now I'm kind of burnt out on this language model stuff. And GBT-3 came out like, nope, back, I'm coming back. I'm back boys. So I updated very hard. I pivoted back to this and I'm like, okay, look, it's hard sometimes hindsight bias to see how things were.
...
**Michaël**: So did you find the less team step by step?
...
**Michaël**: Thanks for add additional bits. Most people look at models through Twitter. They look at cool outputs and yeah, I guess the most impressive models so far have been Dalle-2 imaging party. So they can show their understanding by just throwing like cool pictures. Were you impressed by those at all?
...
**Michaël**: Let me think, I'm just going to cut this, but it's just something I had in my mind. What was I going to say? Is the sound and stuff in camera okay?

Speaker 1:
Yeah, it's all good.

**Michaël**: Dalle, Dalle PaLM, Dolly Dolly PaLM. Well, I don't know. I forgot what I wanted say. Yeah, anyway, just like PaLM, you can test the understanding of the model. You can just send him text and you can get good pictures. And there's no way of saying there's no understanding and I guess the same thing with PaLM as well. You can understand the jokes, can you explain the jokes for you? And more and more is getting harder to poke at the models and say that they're not really intelligent or...

**Michaël**: I had a very good point, but I forgot about it.

**Connor**: Oh, it's fine.

**Michaël**: Dalle. Dalle. Yeah, anyway, so yeah... So with Dolly, did you have some experimentation, some stuff you did that made you think, oh, this is very smart or-

**Connor**: No, not really. It was just like, so I had some experience with the open source kind of models and such. And one of the things they struggled with is called object coherence. So objects were kind of like bleed into each other and stuff like that. That was quite tricky. And it's something I expected to be solved by scale and Dalle was kind of the confirmation that you just give it a big data set, you just scale it. And then it can totally coherently, just separate objects. There was some probability that this was actually a fundamental flaw on the method, that there's something about how we generate images that just makes cleanly separating objects not possible.

**Connor**: But clearly that was not the case. That was the only update I got from Dalle. Is like, I knew you would get better and better models and go on and such and it's probably happen pretty fast. Just whether objects could be this cleanly separated was not super clear to me, but in retrospect, it's not a big update. If I would've bet, I would be like 90% this is solved by scale. So it's a small update, but it's not a large update.

**Michaël**: I think that's a point by where it's just like, okay, it makes some mistakes, but will it be solved by scale or not? That's the question and yes, it will be solved by scale probably.

**Connor**: Yeah, I think a lot of these things will be solved by scale. Even Dalle is still like a quite small model. It's like 3 billion parameters or something like that. It's like pretty small.

**Michaël**: Right, so now I remember my point. So I'm just to edit it and say that before. But yeah, so we are basically in the movie, Don't Look Up where there's an asteroid coming and every time we react to something, oh, it's not very smart. Oh, you cannot go to a red cube on top of a blue cube. We're basically like the journalists in the movie Don't Look Up where there's this asteroid coming and be like, oh yeah, just an asteroid, we can just deflect it, the very problem. And the audience is just watching the movie and be like, what the fuck guys. Do something about the asteroid, do something. We're just screaming at the movie.
...
**Michaël**: Gotcha and on the memes that I mentioned, we talked a lot about AGI and I think to grow the discussion a little bit more, we should just maybe define it or just use definition a we both find useful to talk about it.

**Connor**: Yeah, so this is-

**Michaël**: Or we can bend this word as well.

**Connor**: No. Yeah, so, no, I think this is good. I think AGI is actually a good word.

**Connor**: So my favorite definition, I think is from a post from Steven Burns, which I think may not be posted yet. It may be posted by the time this episode goes out where he kind of like pushes back against Yanlakun who argues that generally AI doesn't exist. So the way I think about the word AGI is there are definitions which are wrong in technicalities, but true in spirit. And there are those that are technically maybe you know, accurate but wrong in spirit. So I like the ones who are true in spirit, but every time I bring those up, some nitpicky will be like, well actually, technically what you just said is incoherent. And I'm like, okay, sure. I'm aware of this. Finding a real technical definition is extremely hard and almost always missing. So for the purpose of this discussion, I think is more productive if we use a definition, which is not 100% technically rigorous, but brings across more of the spiritual correctness, the vibe. This is what the zoomers say I guess.

**Michaël**: We are in California.

**Connor**: We're in California, true, true. I have to adapt to the culture more but yeah. So I think the obvious definition, a lot of people use, something and a system that can do anything a human can do as good or better. I think that's a pretty reasonable... And not just one individual human, a system that can do any task, any human can do as good or better than a median human could, depending on which definition you want to use.
...
**Connor**: So they might be a relatively simply arithmetic core, to the kind of general reasoning that humans do, which, again, some like... or Yan McCoon Schmidt Huber might be bursting through my door right now like, "Well actually, not truly general because no free lunch or whatever." Right? And like, "Okay, sure, fine." "Humans suck at theorem improving or whatever." Right? "But we can build computers."

**Connor**: "So does it really matter?" So the definition I really like, which is this definition that Steve uses in this post, which may or may not be released, is he points out that some people say, well, like anything I would say this, and by the way, I am very sorry to anyone. I am misrepresenting you. Sorry Yan. Sorry Yugan. I'm sorry if I'm misrepresenting any of you, guys not my intention.
...
**Michaël**: Right. The performance on down stream task are yes. Discontinues. And I think, yeah, so you're basically saying that, copying yourself, another server could be a convergence instrumental goal for an AI. And that might happen before you get, you're able to self improve?

**Connor**: It doesn't even have to be the AI doing it. It could just be the researcher testing some new architecture or something. And then his test on is local machine. It doesn't really perform that well. Or it seems totally harmless. And then they scale it up to the whole Open I cluster or whatever. And then suddenly just does something crazy. But what I'm saying is, this is not... I'm not saying this is going to happen definitely or something. And what I'm saying is we can't rule this out. My whole, this is like one of the main things, I like to stress. It's not, I'm not saying, I know this is how the world is going to end. This is how AGI is going to happen. This is when it's going to happen.
...
**Connor**: It feels like, I don't think it's that obs... That crazy of a proposition that maybe a few more researchers should take this seriously or at least not shit talk it on Twitter. I think this is a pretty reasonable thing.
...
**Michaël**: Right. So they're Co-related, but I just like to make a distinction between two times, two kind of people were either very bullish on AI, short timelines but optimistic and people were longer timelines and maybe a bit more optimistic because they have more time and those people are not as concerned as you probably, and I guess not working maybe as hard or there's not trying high risk startups. So yeah. Do you have any other thoughts on this report? Or some stuff that, because you said you agreed with it at the beginning and-

**Connor**: Yes.

**Michaël**: Then maybe you have some disagreements?

**Connor**: Yeah. So I have some thoughts in that report. So first of all, I wanted to point out that I think it's great that it was done agreed. I am so happy that someone just actually sat down and just did the work. That is that report is like "Jesus Christ, that must have been a lot of work to put that thing together." The amount of effort put into really exhaustively looking into every point, really writing down everyone, every assumption, every calculation, justifying things truly this is, this is the kind of stuff I love about EA and rationalism.

**Connor**: It's just this kind of just taking an idea, whether or not it's crazy and just really running with it. Just really going through the whole thing. So big props to Ajeya and everyone else who was involved in that report. I'm really glad it was done. I do disagree with the conclusion still. And so first I have a few problems with the definition of TAI as the kind of thing we should be concerned about.
...
**Connor**: Yeah. So I think the definition transformative AI was something like a system that can perform any economically valuable task a human in front of a computer could do, or a remote worker could do or something. And I think it helps out some definition about a certain percentage of the economical work. 50% of economical work could be performed by this AI or something like that. I don't remember the exact definition. Unfortunately,
...
**Connor**: Oh Yeah. Yeah. That's similar to Paul's definition of slow takeoff, where he talks about... And also Heinson's to degree. So it's good that you bring that up because so one very strong opinion I have is GDP is absolutely one of the worst possible measures for AGI progress. And there's very, very good reasons. We should never use it. John Wentworth, I believe wrote a very good post about this, or maybe it was Daniel Kokotajlo.
...
**Connor**: I think that's a... Seems like a reasonable scenario that could occur. I'm not saying it will, but it's like, again, seems like a pretty reasonable scenario. So for these kind of reasons, I think the definition of TAI is kind of... It has the benefit of being coherent. This is a thing I can talk and reason about, but it has the problem that I don't think this is the actual thing we should be worried or care about. And that, I expect by the time TAI is technically created, it may already be way too late.
...
**Michaël**: And possibly we could get... They could know that we're close to a fast takeoff. And we have no idea because we didn't have access to the four models. So yeah, those posts were 2020, 2021. Those were answers to AGI Contra report. But now in 2022, we had another debate between Paul Christiano and Eliezer Yudkowsky, as you might be aware of. One, the first post was by Elizer Yudkowsky, called... I think the first post was Die With Dignity. There was a troll post in April, but administrative, it counts to the debate.
...
**Connor**: Yes. And the truth is that is very hard to do. So I didn't update as negatively as other people did. I was like, "This is actually a very hard thing to do. This is hard, to find bets like this." But also, I see in this sense, Paul was being more traditionally rationally virtuous in a sense. But so here's my hot take. And I don't know if Eliezer agrees with this or not. Eliezer, if by some chance you ever listen and you disagree with me, I'm sorry.
...
**Connor**: And I think for example, with the Against Biological Anchors thing, what he was trying to do was to convey an antimeme, not to convey a prediction. Paul thought Eliezer is trying to weasel out of her prediction because he doesn't have one. Eliezer is trying to say, I have invaluable antimeme that people should understand and I'm trying to communicate it to you, but I'm failing because it's hard to communicate. And this brings us to the Death with Dignity post. So the Death with Dignity post, you might say, "Connor, this sounds insane. What the fuck are you talking about? Antimemes? That seems ridiculous. I can't think of a single example of an antimeme." That's the point.
...
**Connor**: The antimeme is in a very, very hidden spot. The third paragraph. I'm joking, but I'm not. So why I love this post so much as an example of an antimeme is that he literally spells out the antimeme. Literally word for word, spells out what the antimeme is. And then the top rated comment completely misses it. It's actually amazing. So the antimeme in the post is that, so the surface aesthetic, the first two paragraphs or something are this, "Oh, we're all fucked. Let's all be depressed." And then in the third or fourth paragraph or whatever, whatever the exact paragraph is, he explains what he actually means by this.
...
**Michaël**: Please, Eliezer easier stop writing real thick as well.
...
**Connor**: And there are several others, just really great EleutherAI people on board with this idea, who want to do something like this. So I was like, oh, well yeah, I'll go to Open Phil. Everyone keeps saying there's so much money in EA, and there's nothing they can fund. Surely they will fund me.
...
**Connor**: And then ... this is not perfect, obviously ... this is not a full solution, but this is what I expect the first partial solutions to look like. And so this is why two of the main things that Conjecture works on, is, a, interpretability work. The reason we work on interpretability, and we've just published our first technical post about interpretability, which is on how to defeat mind readers, just today.
...
**Michaël**: Are you also planning to work on keeping up with set up yards, scaling-up models, and being an AGI company, whatever that is, just thinking about AGI in some sense?
