...
Michaël: From looking at the poem paper from Google, they seem pretty clever on how they use their compute.
...
Michaël: So as we're on like gossip, I think like something that was around on the internet, like right when GP3 was launched was that Google was like reproduced it in a few months afterwards, but they didn't really talk about it publicly. I'm not sure about what to do with this information.

Ethan: I know like the DeepMind language models papers that they were a year old when they finally put 'em out on archive or whatever, like Gova and Chinchilla. They had the language model finished training a year before the paper came out.
...
Ethan: I guess, but I mean like I feel like GPT-3, they threw the paper on archive pretty soon after they finished training GPT-3.
...
Michaël: So I think you could just like retrace all some movement tweet and then like you read the next paper like six months after and you're like, oh yeah, he tweeted about that. Like sometime the tweets like, oh, AI is going to be wild, or oh, neural networks are really capable of understanding. I think you tweeted that like six months ago, like when they discovered GPT-4.

Ethan: OpenAI is like when Elea tweeted the consciousness tweet, they're like, goddamn, GPT-4 must be crazy.

Michaël: Yeah, neural networks are in some ways slightly conscious.

Ethan: Yeah, yeah, that was the funniest quote.

Michaël: Yeah, I think people at OpenAI know things we don't know yet. They're all like super hype. And I think you mentioned as well that at least privately that Microsoft has some deal with OpenAI and so they need to some amount of money before 2024, like.
...
Michaël: You mentioned you have like Delhi, but like for designing chips.
...
Ethan: Oh shit. You look like a cone of Lex Fridman from the side.

Michaël: What?

Ethan: When your face is like sideways, you look like a cone of Lex Fridman.

Michaël: Yeah.

Ethan: Like, 'cause your haircut's like identical to his when

Michaël: I'll take that as a compliment that let's work out. And now I can directly be set a free man. So yeah, you think Ciavarella was the meaning of life.

Ethan: Probably just maximize the flourishing as sentient beings, like a very generic answer.

Michaël: Right. So I've done my left man question. Now I'm just basically in.
...
Michaël: And yeah, now you were kind of interested in scaling because it's useful to predict kind of what the whole field of AI is going.

Ethan: And also it just, it's I think people underestimate how easy it is to be contrived if you're not paying attention to scaling trends and trying to like extrapolate to compute budgets and data budgets that are like, well, be the compute data and data budgets and like five years from now.
...
Ethan: I don't know, I don't know. I mean, that's the thing though, like Anthropics got that paper like predictability and surprise and generative models and they're just like, it's unpredictable. We can't predict it. And I'm like, ah, you guys, nah, I don't believe.
...
Ethan: Ken is like the myth day objective open-endedness, like Ken Stanley Jeff Cones, like all that stuff. It's like, I don't know. Just Google, like Ken Stanley open ended at some point. You've probably heard of it, but it's not like registering what I'm referencing.

Michaël: Okay, so maybe one kind of last open-ended question. On a scale from Paul Christiano, Eric Rakowski, Sam Altman, how optimistic are you?

Ethan: Definitely not like Elazi or Dumer type person. I guess probably Paul Christiano is most similar. I mean, I feel like Paul Christiano is in the middle of the people you just said.
...
Michaël: Awesome, so we get the good version as last sentence, and that's a conclusion for the both yes. Thanks, Ethan, for being on the show.